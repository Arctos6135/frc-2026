...
public class FieldConstants {
    ...
    public static final double ROBOT_START_LINE_TO_ALLIANCE_WALL = 4.03;
    public static final double HUB_HALF_SIZE = 1.19;
    public static final double ROBOT_START_LINE_TO_CENTRELINE = FIELD_LENGTH_CENTRELINE - ROBOT_START_LINE_TO_ALLIANCE_WALL;
